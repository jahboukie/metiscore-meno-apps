        ...
        <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-blue-700 mb-4">
                  ...
                  This provides good security for personal use.
                </p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p>• All data is encrypted both at rest and in transit</p>
              <p>• Encryption keys are never transmitted or stored in plain text</p>
              <p>• Web Crypto API provides cryptographic operations</p>
              <p>• Regular security audits ensure compliance with healthcare standards</p>
            </div>
          </div>
        </div>
